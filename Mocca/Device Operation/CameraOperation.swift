...
class CameraOperation: CameraOperationProtocol {
    ...
    public static func setIso(_ iso : Float, for device: AVCaptureDeviceContract, utils:CaptureUtils, completion: @escaping (CMTime) -> Void) throws {
    ...
    public static func setExposure(seconds : Float64, for device: AVCaptureDeviceContract, utils:CaptureUtils, completion: @escaping (CMTime) -> Void) throws {
    ...
    static func willTargetBiasHaveEffect(ev: EV, for device: AVCaptureDeviceContract) -> Bool {
    ...
    public static func setExposurePointOfInterest(_ point:CGPoint, on layer: AVCaptureVideoPreviewLayerContract, for device: inout AVCaptureDeviceContract) -> Result<Void, OperationError> {
    ...
    public static func setFocusPointOfInterest(_ point:CGPoint, on layer: AVCaptureVideoPreviewLayerContract, for device: inout AVCaptureDeviceContract) -> Result<Void, OperationError> {
